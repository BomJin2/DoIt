      ...
      <div className="relative flex flex-col gap-3">
        <Dialog>
          <DialogTrigger asChild>
            <Button size={"icon"} className="absolute top-2 right-4 z-10 bg-neutral-500 bg-opacity-50 hover:bg-opacity-50">
            ...
            <div className="flex flex-col items-center space-x-2 gap-3">
              ...
              <div className="flex flex-col w-full gap-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">{data.description ? data.description : "등록된 묘사 및 설명글이 없습니다."}</span>
                </div>
              </div>
        ...
        {/* 이미지 데이터가 렌더링 된 후 */}
        <img src={data.urls.small} alt={data.alt_description} className="w-[250px] h-[150px] rounded-xl object-cover" />
