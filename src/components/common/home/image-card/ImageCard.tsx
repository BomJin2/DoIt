    ...
    <>
      <div className="flex flex-col justify-between space-y-3 w-64 h-64 cursor-pointer">
        <div className="relative flex flex-col gap-3">
          <Dialog>
            ...
            <DialogContent className="sm:max-w-xl">
              ...
              <div className="flex flex-col items-center space-y-2 gap-3">
                ...
                <img src={data.urls.regular} alt="image" className="h-80 w-full rounded-xl object-cover" />
                ...
                <div className="flex items-center justify-end w-full gap-4">
                  ...
                  <div className="flex items-center gap-1 text-sm">
                    ...
                    {data.likes.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",")}
                  </div>
                </div>
              </div>
            </DialogContent>
          ...
          <img src={data.urls.regular} alt="image" className="w-[250px] h-[150px] rounded-xl z-0 object-cover" />
